      ...
      <div className="container mx-auto px-4">
        <AnimatedElement animation="up">
          <div className="text-center mb-16">
            <span className="inline-block py-1 px-3 rounded-full bg-primary-100 text-primary-700 text-sm font-medium mb-4">CONTACT US</span>
                ...
                <div className="p-8">
                  ...
                  <div className="mt-8 pt-6 border-t border-gray-100">
                    ...
                    <div className="flex space-x-3">
                      <a href="https://www.facebook.com/aweshelectronic" target="_blank" rel="noopener noreferrer" className="bg-primary-50 text-primary-600 p-2 rounded-full hover:bg-primary-600 hover:text-white transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                          <path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" />
                        </svg>
                      </a>
                      <a href="https://www.instagram.com/awesh_electronic?igsh=MWE4MGpheXIyd2p1Ng==" target="_blank" rel="noopener noreferrer" className="bg-primary-50 text-primary-600 p-2 rounded-full hover:bg-primary-600 hover:text-white transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                      ...
                      <a href="https://in.linkedin.com/company/aweshelectronicandelectrical" target="_blank" rel="noopener noreferrer" className="bg-primary-50 text-primary-600 p-2 rounded-full hover:bg-primary-600 hover:text-white transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <AnimatedElement animation="right" delay={400} className="lg:col-span-2">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      <label 
                        ...
                        className={`block text-sm font-medium mb-1 transition-colors ${
                          focusedField === 'name' ? 'text-primary-600' : 'text-gray-700'
                        }`}
                      >
                        Full Name
                      </label>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <label 
                        htmlFor="phone" 
                        className={`block text-sm font-medium mb-1 transition-colors ${
                          focusedField === 'phone' ? 'text-primary-600' : 'text-gray-700'
                        }`}
                      >
                        Phone Number
                      </label>
                    ...
                    <div>
                      <label 
                        htmlFor="service" 
                        className={`block text-sm font-medium mb-1 transition-colors ${
                          focusedField === 'service' ? 'text-primary-600' : 'text-gray-700'
                        }`}
                      >
                        Service Required
                      </label>
                  ...
                  <div>
                    <label 
                      htmlFor="message" 
                      className={`block text-sm font-medium mb-1 transition-colors ${
                        focusedField === 'message' ? 'text-primary-600' : 'text-gray-700'
                      }`}
                    >
                      Your Message
                    </label>
              ...
              <div className="mt-6 grid grid-cols-3 gap-4 text-center">
                <div className="bg-white p-4 rounded-lg shadow-sm border border-gray-100">
                  <div className="mx-auto w-8 h-8 flex items-center justify-center rounded-full bg-primary-100 text-primary-500 mb-2">
